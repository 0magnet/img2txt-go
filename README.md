...
**[Live demo](https://img2txt-go.magnetosphere.net/)** — drop in an image, pick a width, dither algorithm and output format. It runs the same pipeline the binary does, and the image never leaves the tab.
